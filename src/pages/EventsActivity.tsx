...
// Extracted from ProfilePage's old owner-only "Activity" tab — same
  ...
  return (
    <div className="min-h-screen bg-canvas px-4 pt-6 pb-16">
      <div className="max-w-xl mx-auto">
        ...
        <h2 className="font-display text-2xl text-ink mb-6">Events &amp; meetings</h2>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col gap-2">
                {upcoming.length === 0 ? (
                  ...
                  upcoming.map((item, i) => (
                    <ActivityRow key={`${item.kind}-${item.projectId}-${i}`} item={item} />
                  ))
                )}
              </div>
            </div>
